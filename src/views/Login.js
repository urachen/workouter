  ...
  if (isForgot === false && isSignUp === false) {
    board = (
      <Fragment>
        ...
        <Typography variant="h6" align="center" gutterBottom className="text">
          Don’t have an account ?<a className="link" onClick={changeSignUp}> Sign Up </a>Now !</Typography>
      </Fragment>
    );
  }
  if (isForgot) {
    board = (
      <Fragment>
        <Typography variant="h4" align="center" gutterBottom className="text">
          <span>- Reset Your Password -</span>
        </Typography>
        <Typography variant="h5" align="left" gutterBottom className="text">
      ...
      <div className="bg-login">
        ...
        <Container maxWidth="lg" className="board-copyright">
          <Grid container justify="center">
            <Grid item lg={4} sm={10} xs={10}>
              <Typography variant="body1" align="center" gutterBottom className="text-copyright">
                COPYRIGHT © 2020 Workouter. ALL RIGHTS RESERVED.</Typography>
            </Grid>
          </Grid>
        </Container>
      </div>
