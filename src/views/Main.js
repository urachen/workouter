    ...
    <Fragment>
            ...
            <Container maxWidth="lg">
              ...
              <Grid container alignItems="center" justify="center">
                <Grid item lg={4} xs={12} className="chart-item">
                  <div className="circle bg-color-green" onClick={() => handleOpenPopover(event, "times")}>
                ...
                <Grid item lg={4} xs={12} className="chart-item">
                  <div className="circle bg-color-beige" onClick={() => handleOpenPopover(event, "mins")}>
                    <Typography variant="h1">
                ...
                <Grid item lg={4} xs={12} className="chart-item">
                  ...
                  <div class="pie-item">
                    <div class="pie-circle-dark"></div>
                    <span>重訓:80%</span>
                    <br />
                    <div class="pie-circle-light"></div>
                    <span>瑜珈:20%</span>
                              ...
                              <div>
                                {todayItem.startTime && todayItem.endTime ?
                                  <Fragment>
                                    ...
                                    <Typography variant="h6" color="textSecondary" gutterBottom>{todayItem.startTime} ~ {todayItem.endTime}</Typography>
                                  </Fragment> : <Fragment></Fragment>
                                }
                                {todayItem.place ?
                                  <Fragment>
                                    <Typography variant="h5" display="block" gutterBottom><RoomIcon /> Place</Typography>
                                    <Typography variant="h6" color="textSecondary" gutterBottom>{todayItem.place}</Typography>
                                  </Fragment> : <Fragment></Fragment>
                                }
                                {todayItem.memo ?
                                  <Fragment>
                                    <Typography variant="h5" display="block" gutterBottom><MenuBookIcon /> Memo</Typography>
                                    <Typography variant="h6" color="textSecondary" gutterBottom>{todayItem.memo}</Typography>
                                  </Fragment> : <Fragment></Fragment>
                                }
      ...
      >
        <Fragment>
          ...
          {content.map(item =>
            <Fragment>
              <Typography variant="h5" display="block" gutterBottom>{item.date}</Typography>
              {item.records && item.records.map(rItem =>
                <Typography variant="h6" color="textSecondary" gutterBottom>{rItem.name}</Typography>
              )}
            </Fragment>
          )}
        </Fragment>
